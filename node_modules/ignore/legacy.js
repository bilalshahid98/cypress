    ...
    _createClass(Ignore, [
      ...
      },
      {
        ...
        value: function add(pattern) {
          ...
          ).forEach(this._addPattern, this); // Some rules have just added to the ignore,
      ...
      },
      {
        ...
        value: function _test(originalPath, cache, checkUnignored, slices) {
          var path = originalPath && checkPath.convert(originalPath); // Supports nullable path
