    ...
    const req = fn.request(opts, res => {
      ...
      if (
        ...
        if (++redirectCount > 10) {
          ee.emit(
            "error",
            new got.MaxRedirectsError(statusCode, opts),
            null,
            res
          );
          return;
      ...
      setImmediate(() => {
        const response =
          typeof unzipResponse === "function" && req.method !== "HEAD"
            ? unzipResponse(res)
            : res;
...
got.ParseError = createErrorClass("ParseError", function(
  e,
  statusCode,
  opts,
  data
...
got.MaxRedirectsError = createErrorClass("MaxRedirectsError", function(
  statusCode,
  opts
) {
  stdError.call(this, {}, opts);
